<template>
  <tab-bar>
    ...
    <tab-bar-item path="/car">
      <img src="~assets/img/tabbar/shopcar.svg" slot="item-icon">
      <img src="~assets/img/tabbar/shopcar-active.svg" slot="item-icon-active">
      <div slot="item-text">购物车</div>
    </tab-bar-item>
    <tab-bar-item path="/profile">
      <img src="~assets/img/tabbar/me.svg" slot="item-icon">
      <img src="~assets/img/tabbar/me-active.svg" slot="item-icon-active">
